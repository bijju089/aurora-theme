            ...
            {if $DISCORDVIEW eq '1'}
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputDiscordID" name="discordID"
                        placeholder="Enter your Discord server ID" value="{$DISCORDID}">
                </div>
            {/if}
            <div class="form-group">
